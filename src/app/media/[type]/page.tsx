...
export default function MediaTypePage() {
    ...
    const typeMap: Record<string, 'article' | 'photo' | 'video'> = {
        'articles': 'article',
        'photos': 'photo',
        'videos': 'video'
    };

    const mediaType = typeMap[typeParam];
    const mediaItems = mediaType ? getMediaByType(mediaType) : [];
    const typeMeta = mediaType ? mediaTypes[mediaType] : null;
    ...
    if (!mediaType || !typeMeta) {
        return (
            <main className="min-h-screen bg-neutral-50 dark:bg-neutral-900 pt-24 pb-16">
                <div className="container mx-auto px-6">
                    <div className="text-center py-16">
                        <h1 className="text-3xl font-bold text-neutral-900 dark:text-white mb-4">
                            {language === 'en' ? 'Type Not Found' : 'Tipe Tidak Ditemukan'}
                        </h1>
                        <Link href="/media" className="text-blue-600 dark:text-blue-400 hover:underline">
                            {language === 'en' ? 'Back to All Media' : 'Kembali ke Semua Media'}
                        </Link>
                    </div>
                </div>
            </main>
            ...
            <div className="container mx-auto px-6">
                ...
                <div className="mb-12">
                    <h1 className="text-4xl md:text-5xl font-bold text-neutral-900 dark:text-white mb-3">
                        {language === 'en' ? typeMeta.en : typeMeta.id}
                    </h1>
                    ...
                    <div className="flex items-center gap-2 text-sm text-neutral-500 dark:text-neutral-500 h-5 mb-4">
                        <Link href="/media" className="hover:text-blue-600 dark:hover:text-blue-400">
                            {language === 'en' ? 'Media' : 'Media'}
                        </Link>
                        <span>›</span>
                    ...
                    <p className="text-base text-neutral-600 dark:text-neutral-400 max-w-3xl min-h-[3rem]">
                        {language === 'en' ? typeMeta.description.en : typeMeta.description.id}
                    </p>
                </div>
                        ...
                        {mediaItems.length === 0 && (
                            <div className="text-center py-16">
                                ...
                                <p className="text-neutral-500 dark:text-neutral-400">
                                    {language === 'en' ? 'No media found in this type' : 'Tidak ada media ditemukan di tipe ini'}
                                </p>
                            </div>
                        )}
                    </div>
