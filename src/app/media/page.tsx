                            ...
                            {mediaItems.map((item) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className={`relative bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-900/20 dark:to-cyan-900/20 ${viewMode === 'list' ? 'w-24 h-24 md:w-72 md:h-auto shrink-0' : 'w-full h-56'}`}>
                                        ...
                                        {/* Content */}
                                        <div className={`${viewMode === 'list' ? 'p-3 md:p-6' : 'p-6'} flex flex-col flex-1`}>
                                            <div className="mb-auto">
                                                <h2 className={`${viewMode === 'list' ? 'text-sm md:text-xl' : 'text-xl'} font-bold text-neutral-900 dark:text-white mb-2 md:mb-3 line-clamp-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors`}>
