...
export type GroupWhereInput = {
  ...
  abrv?: Prisma.StringFilter<"Group"> | string
...
export type GroupScalarWhereWithAggregatesInput = {
  ...
  abrv?: Prisma.StringWithAggregatesFilter<"Group"> | string
...
export type GroupOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"uid" | "abrv" | "name" | "is_active", ExtArgs["result"]["group"]>
...
export interface GroupDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `uid`
   * const groupWithUidOnly = await prisma.group.findMany({ select: { uid: true } })
   * 
   */
   ...
   * const groupWithUidOnly = await prisma.group.createManyAndReturn({
   *   select: { uid: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * const groupWithUidOnly = await prisma.group.updateManyAndReturn({
   *   select: { uid: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface GroupFieldRefs {
  ...
  readonly abrv: Prisma.FieldRef<"Group", 'String'>
