...
export type ProvinceWhereInput = {
  ...
  uid?: Prisma.StringFilter<"Province"> | string
  kode?: Prisma.StringFilter<"Province"> | string
...
export type ProvinceScalarWhereWithAggregatesInput = {
  ...
  uid?: Prisma.StringWithAggregatesFilter<"Province"> | string
  kode?: Prisma.StringWithAggregatesFilter<"Province"> | string
...
export type ProvinceOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"uid" | "kode" | "name", ExtArgs["result"]["province"]>
...
export interface ProvinceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `uid`
   * const provinceWithUidOnly = await prisma.province.findMany({ select: { uid: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Provinces and only return the `uid`
   * const provinceWithUidOnly = await prisma.province.createManyAndReturn({
   *   select: { uid: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Provinces and only return the `uid`
   * const provinceWithUidOnly = await prisma.province.updateManyAndReturn({
   *   select: { uid: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ProvinceFieldRefs {
  readonly uid: Prisma.FieldRef<"Province", 'String'>
  readonly kode: Prisma.FieldRef<"Province", 'String'>
